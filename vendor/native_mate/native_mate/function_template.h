...
template <template<typename> class Callback, typename IndicesType, typename... ArgTypes>
class Invoker {};

template <template<typename> class Callback, size_t... indices, typename... ArgTypes>
...
template <template<typename> class Callback, typename ReturnType, typename... ArgTypes>
...
v8::Local<v8::FunctionTemplate> CreateFunctionTemplate(
    v8::Isolate* isolate, const Callback<Sig> callback,
...
void CreateFunctionHandler(v8::Isolate* isolate,
  ...
  typedef internal::CallbackHolder<Callback, Sig> HolderT;
  HolderT* holder = new HolderT(isolate, callback, callback_flags);
  tmpl->SetCallAsFunctionHandler(&internal::Dispatcher<Callback, Sig>::DispatchToCallback,
